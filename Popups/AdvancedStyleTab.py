...
class AdvancedStyleTab(ABCSettingTab):
    def __init__(self, session: Session, parent=None):
        ...
        self.style_textarea.setPlainText(self.session.settings.style.raw_style_sheet)
        self.style_textarea.setObjectName("StyleTextArea")

        self.var_textarea = QPlainTextEdit()
        self.var_textarea.setPlainText(self.session.settings.style.raw_vars)
    ...
    def apply(self):
        ...
        self.session.settings.style.update_style(var_map=var_map, style_sheet=self.style_textarea.toPlainText())
